...
if __name__ == '__main__':
    ...
    # ir_path = "../dataset/ir2vis/RoadScene/ir" #for ori svs maps
    # vi_path = "../dataset/ir2vis/RoadScene/vi"
    # ir_path = "../dataset/ir2vis/RoadScene/ir_reverse" #for reversed svs maps
    # vi_path = "../dataset/ir2vis/RoadScene/vis_reverse"
    ir_path = "../dataset/choice/RoadScene724/ir"  # for ori svs maps
    vi_path = "../dataset/choice/RoadScene724/vis"
    # vi_path = "../results_Road/Reg/230308_act/vis_reg_img"

    ir_file_list = sorted(os.listdir(ir_path))
    vi_file_list = sorted(os.listdir(vi_path))

    # ir_map_path = "../dataset/test/0311_source/ir_map"
    # vi_map_path = "../dataset/test/0311_source/vi_map"
    ir_map_path = "../dataset/test/0724_source/ir_map"
    vi_map_path = "../dataset/test/0724_source/vi_map"
