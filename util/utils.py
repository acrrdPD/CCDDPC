...
def randflow(img,angle=7,trans=0.07,ratio=1,sigma=15,base=500):
    ...
    disp = disp.to(img.device)  # dky
    base_scale = base_scale.to(img.device)  # dky
